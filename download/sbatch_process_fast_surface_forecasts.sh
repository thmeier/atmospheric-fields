...
if [[ "${MODEL}" == "gfs" ]]; then
  INPUT_DIR="${INPUT_DIR:-/work/scratch/yelberkennou/gfs_fast}"
  SCRATCH_DIR="${SCRATCH_DIR:-/work/scratch/yelberkennou/gfs_fast_processed/scratch}"
  OUTPUT_DIR="${OUTPUT_DIR:-/work/scratch/yelberkennou/gfs_fast_processed/regridded}"
  START_DATE="${START_DATE:-20220101}"
  END_DATE="${END_DATE:-20221231}"
  CYCLES="${CYCLES:-00 06 12 18}"
  MEMBERS="${MEMBERS:-0}"
elif [[ "${MODEL}" == "gefs" ]]; then
  INPUT_DIR="${INPUT_DIR:-/work/scratch/yelberkennou/gefs_fast}"
  SCRATCH_DIR="${SCRATCH_DIR:-/work/scratch/yelberkennou/gefs_fast_processed/scratch}"
  OUTPUT_DIR="${OUTPUT_DIR:-/work/scratch/yelberkennou/gefs_fast_processed/regridded}"
  START_DATE="${START_DATE:-20220101}"
  END_DATE="${END_DATE:-20221231}"
  CYCLES="${CYCLES:-00}"
  MEMBERS="${MEMBERS:-0}"
