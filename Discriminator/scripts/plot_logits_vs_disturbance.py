...
# They support a wider analysis grid, including out-of-distribution probes such
# as patch dropout and quantization that are not used during training.
...
class DisturbanceDataset(Dataset):
    """Apply one disturbance level to ERA5 samples at inference time."""
...
def main(cfg: DictConfig):
    """Run disturbance sensitivity analysis for one trained discriminator."""
